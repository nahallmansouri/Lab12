...
public class DrawFrame extends JFrame
{
    ...
    public DrawFrame(String title)
    {
        ...
        // Ears:
        RightTriangle backEar1 = new RightTriangle(new Point(150,150), 25, 100 , Color.DARK_GRAY, true);
        RightTriangle backEar2 = new RightTriangle(new Point(200,150), 25, 100 , Color.DARK_GRAY, true);
